...
class Newsdetail extends StatelessWidget {
  ...
  shape: CircleBorder(),
   ...
   SliverList(
          ...
          //    shrinkWrap: true,
          //      children: <Widget>[ 
                  Text(berita[index].nama,style:TextStyle(fontSize: 20),textAlign: TextAlign.center,),
              ListTile(
                dense: true,
            ...
            Text(berita[index].deskripsi,textAlign: TextAlign.left,style: TextStyle(fontSize: 15),),
